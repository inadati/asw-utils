...
このファイルは Claude Code が asw-plant リポジトリで作業する際のガイダンスを提供する。

---

## プロジェクト概要

**リポジトリ**: https://github.com/inadati/asw-plant
...
| スキル | 呼び出し | 役割 |
|--------|---------|------|
| `wantree` | `/asw-plant:wantree` | ヒアリング形式で要件定義YAML（wantree.yml）を作成・管理 |
